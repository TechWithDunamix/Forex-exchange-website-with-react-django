          ...
          <div className="mt-8">
            <div className="flex flex-col md:flex-row justify-between mb-4">
              <div className="flex items-center space-x-2 mb-4 md:mb-0">
                <div className="p-2 text-white bg-green-500 rounded-full">01</div>
                <div>
              ...
              <div className="flex items-center space-x-2">
                <div className="p-2 text-white bg-green-500 rounded-full">02</div>
                <div>
            ...
            <div className="text-center">
              <div className="inline-flex items-center p-4 mb-6 text-green-500 bg-green-100 rounded-full">
              ...
              <button
                ...
                className="flex items-center px-4 py-2 mt-4 text-white bg-green-500 rounded hover:bg-green-700 w-full sm:w-auto"
              >
                <PlusOutlined />
