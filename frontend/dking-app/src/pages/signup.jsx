...
import { callMainApi, countries } from "../utils.js";
import "../index.css";
			...
			<div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md mx-5">
				...
				<form className="space-y-6" onSubmit={handleSubmit}>
					<div className="relative">
						...
						/>
						{errors.email && (
							<p className="text-red-500 font-light">Email is already taken by another user </p>
						)}
					</div>
				...
				{isLoading && (
					<div className="mt-5 mr-20 p-4 animate-spin-infinte border-t-4 border-green-500 w-[20px] h-[20px] rounded-[200px]"></div>
				)}
			</div>
