    ...
    <Layout>
	    <div className='flex flex-col items-center'>
			 <div className='min-h-[35vh] flex justify-center items-center bg-slate-100 w-full'>
			    <p className='text-[2rem] text-green-500'>About Us</p>
			</div>
			<div className='-mt-5 px-3 border-2 border-black rounded-lg py-2 animate-slide-fade'>
			<p ><span className = 'text-green-500'>Ex-Change</span>   > About Us </p>
			</div>
			...
			<div className='text-center mt-5'>
				...
				<div className='flex  justify-center flex-col md:flex-row items-center mt-24 mb-16'>
					<div className='mx-5'>
						<UserOutlined className='px-3 bg-green-300 text-green-600 rounded-lg text-[2rem] p-3'/>
					...
					<div className='mx-5'>
						<MoneyCollectOutlined className='px-3 bg-green-300 text-green-600 rounded-lg text-[2rem] p-3'/>
					...
					<div className='mx-5'>
						<LineChartOutlined className='px-3 bg-green-300 text-green-600 rounded-lg text-[2rem] p-3'/>
			...
			<div className='mx-8  md:mx-16 bg-green-800 text-white md:flex p-5 rounded-r-[5px] rounded-t-[5px] w-[80%] my-12'>
  			<div>
