				...
				<div className="border-2 rounded-xl py-5 px-4 w-full max-w-2xl mx-auto">
					<div className="rounded-xl bg-green-200 p-2 ">
						<div className="flex items-center">
							<p className="bg-green-900 text-slate-100 rounded-xl p-1">Your payment method</p>
					...
					<button
						...
						className="cursor-pointer mt-10 hover:bg-green-600 bg-green-700 text-slate-200 p-2 rounded-lg drop-shadow-sm w-full"
					>
						Complete Request
					</button>
				</div>
