				...
				<div className="border-2 rounded-xl py-5 px-4">
					<div className="rounded-xl bg-green-200 p-2 ">
						<div className="flex items-center">
							<p className="bg-green-900 text-slate-100 rounded-xl p-1">Your payement method</p>
					...
					<p className="mt-4" style={{ fontFamily: "Rubik" }}>
					...
					<div className="flex justify-between mt-10">
						...
						{!otp && (
							...
							>
								<MessageFilled />
								{isLoading ? (
									<div className="mx-12 p-q animate-spin-infinte border-t-4 border-green-100 w-[20px] h-[20px] rounded-[200px]"></div>
								) : (
									"Request OTP"
								)}
							</button>
					...
					<input
						...
						onChange={handleChange}
						className="p-3 mt-4 border-2 rounded-lg w-full "
						placeholder="Enter Tether USD (TRC 20) Address"
					/>
					<p className="text-slate-400 mt-10">
						Tether USD (TRC 20) is out default withdrawal option pls,enter the correct wallet
					...
					{confirmed && (
						<button
							...
							className="cursor-pointer mt-10 hover:bg-green-600 bg-green-700 text-slate-200 p-2 rounded-lg drop-shadow-sm"
						>
							Complete Request{" "}
						</button>
					)}
