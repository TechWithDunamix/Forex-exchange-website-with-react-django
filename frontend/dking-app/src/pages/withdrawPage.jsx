            ...
            <div className='min-h-full w-full flex items-center justify-center'>
                <div className='border-2 rounded-xl py-5 px-4'>
                    ...
                    <div className='flex justify-between mt-10'>
                        <p>Enter OTP</p>
                        {!otp && <button onClick={requestOTP} className='items-center flex hover:bg-green-600 bg-green-700 text-slate-200 p-2 rounded-lg drop-shadow-sm'>
                        <MessageFilled />   
                        {isLoading ? <div className='mx-12 p-q animate-spin-infinte border-t-4 border-green-100 w-[20px] h-[20px] rounded-[200px]'></div>:'Request OTP'}
