            ...
            <header className="bg-white shadow-md w-full">
                ...
                {menuOpen && (
                    <div className="md:hidden animate-slide-fade">
                        ...
                        <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-green-600 hover:text-white transition duration-300">FAQs</a>
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col md:flex-row justify-between mb-8">
                        <div className="flex flex-col md:w-1/3 mb-8 md:mb-0">
                            <h2 className="text-2xl font-bold text-green-400 mb-4">EX<span className='text-red-800'>change</span></h2>
                            <p className="text-gray-400 mb-4">Your trusted partner for trading in indices, commodities, and more.</p>
                            <p className="text-gray-400 mb-4">Btc wallet address: <span className="text-green-400">bc1q70luh4hg3afvjzgr8mf03l9f0u2r4vay4wry7q</span></p>
                        </div>
                        <div className="flex flex-col md:w-1/3 mb-8 md:mb-0">
                            <h3 className="text-xl font-semibold mb-4">Quick Links</h3>
                            <a href="/" className="text-gray-400 hover:text-green-400 mb-2 transition duration-300">Home</a>
                            <a href="/about" className="text-gray-400 hover:text-green-400 mb-2 transition duration-300">About</a>
                            <a href="#" className="text-gray-400 hover:text-green-400 mb-2 transition duration-300">FAQs</a>
                            <a href="/contact-us" className="text-gray-400 hover:text-green-400 mb-2 transition duration-300">Contact</a>
                        </div>
                        <div className="flex flex-col md:w-1/3 mb-8 md:mb-0">
                            <h3 className="text-xl font-semibold mb-4">Contact Us</h3>
                            <p className="text-gray-400 mb-2">Phone: <a href="tel:+16292513701" className="text-green-400">+1 (629) 251-3701</a>, <a href="tel:+15406769802" className="text-green-400">+1 (540) 676-9802</a></p>
                            <p className="text-gray-400 mb-2">Email: <a href="mailto:exhchange7@gmail.com" className="text-green-400">exchange7@gmail.com</a></p>
